...
error_reporting(0);
    ...
    $conductor = "SELECT id_conductor, concat(Pnomb_conductor,' ',Snomb_conductor,' ',apell_conductor) 
    AS Nombre, dir_conductor, tel_conductor, ciudad_conductor
    FROM conductores
    ORDER BY apell_conductor ASC;";
?>
    ...
    <section class="cont_inicial2">
        <header class="cont_menu-2">
                    <button class="btn-menu-2"><a href="../edicion/edit_cliente.php">
                        <img class="img_btn" src="../imagenes/edit.png">Editar Conductor</a>
                    </button>
        </header>
        <section class="contenedor">
            
               <form action="../records/regis_conductores.php" method="post"  class="form_registro">
...
?>
                   <tr>
                        <td class="td-1"><?php echo $row["id_conductor"] ?></td>
                        <td class="td-1"><?php echo $row["Nombre"] ?></td>
                        <td class="td-1"><?php echo $row["dir_conductor"] ?></td>
                        <td class="td-1"><?php echo $row["tel_conductor"] ?></td>
                        <td class="td-1"><?php echo $row["ciudad_conductor"] ?></td>
                    </tr> 
